...
| 思想史 | 已有哲学透镜；`YT-A2-MAT-005B` 已补入 6 条《黄帝四经》黄老透镜 | 董仲舒、经学语境、武帝财政国家等背景仍需补强；黄老透镜 UI 分组需另开 `YT-A2-MAT-005C` | 解释儒法、黄老、义利、国家能力等思想来源 | 退朝后思想透镜 | 不直接支撑会议事实 |
...
| P1 | 汉初至武帝思想语境 | 黄老与《黄帝四经》已完成计划冻结、候选短摘核验和首轮入包；经学、董仲舒和财政国家语境仍需后续补强 | 6 条黄老 EvidenceUnit、黄老材料计划、核验文档与后续经学语境卡 |
