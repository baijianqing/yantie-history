...
| 思想史 | 已有哲学透镜；`YT-A2-MAT-005B` 已补入 6 条《黄帝四经》黄老透镜；`YT-A2-MAT-006` 已冻结董仲舒、经学语境和武帝文治正当性计划 | 经学候选短摘、《春秋繁露》版本性质和退朝后分组仍需后续任务补强 | 解释儒法、黄老、经学、义利、国家能力和政治正当性等思想来源 | 退朝后思想透镜 | 不直接支撑会议事实 |
...
| P1 | 汉初至武帝思想语境 | 黄老与《黄帝四经》已完成计划冻结、候选短摘核验和首轮入包；经学、董仲舒和财政国家语境已完成计划冻结，后续需做短摘核验和入包判断 | 6 条黄老 EvidenceUnit、黄老材料计划、核验文档与经学语境计划 |
...
```powershell
git diff --check -- docs/YANTIE_A2_CLASSICS_CONTEXT_PLAN.md docs/YANTIE_A2_MATERIAL_GAP.md docs/YANTIE_TASK_BREAKDOWN.md test/test_yantie_material_docs.py
