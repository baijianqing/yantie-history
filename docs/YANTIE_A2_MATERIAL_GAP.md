...
| 思想史 | 已有哲学透镜；`YT-A2-MAT-005` 已冻结汉初黄老与《黄帝四经》候选透镜；`YT-A2-MAT-005A` 已核验候选来源与短摘 | 董仲舒、经学语境、武帝财政国家等背景仍需补强；《黄帝四经》正式入包需另开 `YT-A2-MAT-005B` | 解释儒法、黄老、义利、国家能力等思想来源 | 退朝后思想透镜 | 不直接支撑会议事实 |
...
| P1 | 汉初至武帝思想语境 | 黄老与《黄帝四经》已完成计划冻结和候选短摘核验；经学、董仲舒和财政国家语境仍需后续补强 | `docs/YANTIE_A2_HUANG_LAO_MATERIAL_PLAN.md`、`docs/YANTIE_A2_HUANGDI_SIJING_VERIFICATION.md` 与后续经学语境卡 |
